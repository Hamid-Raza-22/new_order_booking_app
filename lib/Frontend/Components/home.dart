...
import 'package:new_order_booking_app/Frontend/Components/side_menu.dart';
import 'package:new_order_booking_app/Frontend/Components/theme.dart';
import 'package:rive/rive.dart' hide LinearGradient;
import 'dart:math' as math;
import 'package:new_order_booking_app/Frontend/Components/assets.dart' as app_assets;
import '../Ignore/clockin.dart';
...
class _RiveAppHomeState extends State<RiveAppHome>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned(child: Container(color: RiveAppTheme.purple)),
          RepaintBoundary(
